      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mt-6 border-t pt-6">
          ...
          <ul className="list-none space-y-2">
            <li><strong>Email:</strong> <a href="seuemail@exemplo.com" className="text-blue-600 hover:underline">seuemail@exemplo.com</a></li>
            <li><strong>LinkedIn:</strong> <a href="#" className="text-blue-600 hover:underline">seu-linkedin</a></li>
            <li><strong>GitHub:</strong> <a href="#" className="text-blue-600 hover:underline">seu-github</a></li>
          </ul>
        </div>
      </div>
    </main>
